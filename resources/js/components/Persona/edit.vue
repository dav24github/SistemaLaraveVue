                              ...
                              <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input v-model="form.tipo_persona" type="text" class="form-control" placeholder="Tipo de persona">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button class="btn btn-info"><i class="fas fa-edit"></i> Update Persona</button>
                                    </div>
                                </div>
                            </div>
                        </form>
